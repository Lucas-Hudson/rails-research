...
ActiveRecord::Schema.define(version: 2020_07_05_132300) do
  ...
  create_table "org_places", id: false, force: :cascade do |t|
    t.bigint "org_id", null: false
    t.bigint "place_id", null: false
    t.index ["org_id", "place_id"], name: "index_org_places_on_org_id_and_place_id"
    t.index ["place_id", "org_id"], name: "index_org_places_on_place_id_and_org_id"
  end
